...
class Xy_Navmain_Walker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ( $depth == 0 && in_array( 'menu-item-has-children', $item->classes ) && $this->is_mobile() ) {
            $item_output = '<a>' . $args->link_before . $title . $args->link_after . '</a>';
        } else {
    ...
    public function end_el( &$output, $item, $depth = 0, $args = array() ) {
        ...
        if ($depth == 0) {
            $output .= sprintf('</ul><div class="naversub-footer clearfix">'
                ...
                . '</div>'
                . '<div class="subf-rl">'
                . '<a><span class="tel">联系电话：18020266589</span></a>'
                . '<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=2881781078&site=qq&menu=yes"><span class="titme">7 * 24小时 在线服务时间</span><a>'
                . '<a href="/"><span class="addres">苏州工业园区世纪金融大厦4楼408A<br/>电话:18362725276</span><a>'
                . '</div></div>'
